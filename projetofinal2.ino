...
#define RELE_IN2 14                  //pino D14

//Dados para conectar no Wi-Fi
const char* ssid = "LucasCunha";  
const char* password = "42314231";

const char* mqtt_server = "lucascunhaifsp.duckdns.org"; //aqui pode ser o IP do MQTT ou uma URL
const char* mqtt_username = "admin"; //Usuario criado no broker 
const char* mqtt_password = "270505"; //senha do usuario
